...
class CrowdApi
{
     ...
     * Renames a user
     *
     * @param  string $username name of the user to rename (optional)
     * @param  \CrowdClient\Model\CwdUserRename $newname newname (optional)
     *
     * @throws \CrowdClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \CrowdClient\Model\CwdUser
     */
    public function renameUser($username = null, $newname = null)
    {
        list($response) = $this->renameUserWithHttpInfo($username, $newname);
        return $response;
    }
     ...
     *
     * @param  string $username name of the user to rename (optional)
     * @param  \CrowdClient\Model\CwdUserRename $newname (optional)
     *
     * @throws \CrowdClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \CrowdClient\Model\CwdUser, HTTP status code, HTTP response headers (array of strings)
     */
    public function renameUserWithHttpInfo($username = null, $newname = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function renameUserAsync($username = null, $newname = null)
    {
        return $this->renameUserAsyncWithHttpInfo($username, $newname)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation renameUserAsyncWithHttpInfo
     *
     * Renames a user
     *
     * @param  string $username name of the user to rename (optional)
    ...
    /**
     * Create request for operation 'renameUser'
     *
     * @param  string $username name of the user to rename (optional)
     * @param  \CrowdClient\Model\CwdUserRename $newname (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function renameUserRequest($username = null, $newname = null)
    {

        $resourcePath = '/user/rename';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
