...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'http://localhost/crowd/rest/usermanagement/1';
    ...
    {
        $report  = 'PHP SDK (CrowdClient) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 3.5.0' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return array(
          array(
            "url" => "/crowd/rest/usermanagement/1",
